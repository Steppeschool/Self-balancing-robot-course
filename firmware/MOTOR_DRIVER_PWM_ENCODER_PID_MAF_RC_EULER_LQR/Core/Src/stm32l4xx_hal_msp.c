...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspInit 0 */
    ...
    PB10     ------> SPI2_SCK
    */
    GPIO_InitStruct.Pin = ICM_SPI_MISO_Pin|ISM_SPI_MOSI_Pin;
    ...
    GPIO_InitStruct.Pin = ISM_SPI_SCK_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF5_SPI2;
    HAL_GPIO_Init(ISM_SPI_SCK_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB10     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOC, ICM_SPI_MISO_Pin|ISM_SPI_MOSI_Pin);

    HAL_GPIO_DeInit(ISM_SPI_SCK_GPIO_Port, ISM_SPI_SCK_Pin);
